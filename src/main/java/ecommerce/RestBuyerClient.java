...
//        String portNum = args[2];
        ...
        while (true) {
            System.out.println();
            System.out.println("1 createBuyerAccount: Enter username <space> password");
            System.out.println("2 loginBuyer: Enter buyerId <space> password");
            System.out.println("3 logoutBuyer: Enter buyerId");
            System.out.println("4 addToShoppingCart: Enter buyerId <space> itemId <space> quantity");
            System.out.println("5 removeFromShoppingCart: Enter buyerId <space> itemId <space> quantity");
            System.out.println("6 clearShoppingCart: Enter buyerId");
            System.out.println("7 displayShoppingCart: Enter buyerId");
            System.out.println("8 feedBackSeller: Enter sellerId <space> feedvalue");
            System.out.println("9 sellerRating: Enter sellerId");
            System.out.println("10 searchItems: Enter itemCategory <space> keywords");
            System.out.println("11 purchaseHistory: Enter buyerId");
            System.out.println("12 makePurchase: Enter buyerId <space> buyerName <space> cardNumber <space> expiryDate");
